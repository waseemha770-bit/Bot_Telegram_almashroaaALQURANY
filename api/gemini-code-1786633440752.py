...
# ==========================================
# واجهة الدرس الذكية (إظهار الأزرار الموجودة فقط)
# ==========================================
...
async def handle_callbacks(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "admin_stats" and await has_perm(user_id, "stats"):
        ...
        try:
            ...
            output.seek(0)
            await query.message.delete()
            await context.bot.send_document(chat_id=chat_id, document=output, filename="تقرير_الإحصائيات.xlsx", caption="📊 <b>تقرير الإحصائيات</b>", parse_mode="HTML")
...
👇 <b>أرسل ملف الإكسل الآن كـ (مستند / Document):</b>"""
    ...
    if data.startswith("utype_"):
        ...
        if user.get("state") == "WAIT_CONTENT_TYPE":
            ...
            cat, les, cat_id = temp_data.get("mgr_target_cat"), temp_data.get("mgr_target_les"), temp_data.get("mgr_target_cat_id")
